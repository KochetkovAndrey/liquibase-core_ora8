...
public class OracleDatabaseTest extends AbstractJdbcDatabaseTest {
    ...
    public void getCurrentDateTimeFunction() {
    	...
    	/* Kochetkov Andrey 18.09.2018 Changing checking SYSTIMESTAMP 
        ...
        */
        Assert.assertEquals("Oracle Database's 'give me the current timestamp' function is correctly reported.",
                "SYSDATE", getDatabase().getCurrentDateTimeFunction());
    }
    ...
    public void getDateLiteral_timestamp() {
        /* Kochetkov Andrey 18.09.2018 Changing checking TO_TIMESTAMP function
        ...
        */
        assertEquals("TO_DATE('2017-08-16 16:32:55', 'YYYY-MM-DD HH24:MI:SS')", database.getDateLiteral("2017-08-16T16:32:55.125"));
    }

    @Test
    public void getDateLiteral_datetime() {
        /* Kochetkov Andrey 18.09.2018 Changing checking TO_DATE function with zones
